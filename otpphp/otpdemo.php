                                        ...
                                        <table class="table mb-0 table-center invoice-tb" id="tblData">
                                            <thead class="bg-light">
                                                <tr>
                                                    ...
                                                    <th scope="col" class="text-left">Parent Name</th>
                                                    <th scope="col" class="text-left">Email</th>
                                                    <th scope="col" class="text-left">Number</th>
                                                    <th scope="col" class="text-left">Child Name</th>
                                                ...
                                                <?php
                                                   ...
                                                   $conn = new mysqli('localhost','padhhigh_demoform','padhhigh','padhhigh_demoform');
                                                    if ($conn->connect_error) {
                                                        ...
                                                        $sql = "SELECT id,parent,student, email, contact,  class, city FROM course3";
